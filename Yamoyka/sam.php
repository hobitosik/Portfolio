<?php
  ...
  $mail->Subject = 'Лендинг Ямойка / Записаться на самообслуживание';
  ...
  if(!$mail->Send()) {
    ...
    $body=file_get_contents("http://sms.ru/sms/send?api_id=APIID&to=NUMBERPHONE&text=".urlencode("Самообслуживание. Имя: " . $_POST['name']. ". Телефон: " . $_POST['phone'])); 
