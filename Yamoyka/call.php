<?php
  ...
  $mail->Subject = 'Лендинг Ямойка / Заказать звонок';
  ...
  if(!$mail->Send()) {
    ...
    $body=file_get_contents("http://sms.ru/sms/send?api_id=APIID&to=NUMBERPHONE&text=".urlencode("Заказать звонок. Имя: " . $_POST['name']. ". Телефон: " . $_POST['phone'])); 
