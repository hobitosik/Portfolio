angular.module('myApp').controller('ProfileArticlesCtrl',
function ($scope, $state, $http, jwtHelper, user, articles, categories, favorites, vote, $filter) {
	$scope.blog = [];
	var _blog = [];
	...
	_blog = $filter('orderBy')(_blog, '+added');
